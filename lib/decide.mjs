...
export function validate({ rawCount, rejected }, watcher) {
  if (rawCount < watcher.minListings) {
    return `only ${rawCount} listings (floor ${watcher.minListings}) — load incomplete or blocked`;
  }
